...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/article-management/edit') }}">Edit Artikel</a></li>
    </ol>
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-8">
                    <h1 class="title-pagination text-center mb-3"></h1>
                    <div class="px-2">
                        <form action="{{url('/article-management/edit/'.$article->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="judul" class="form-label">Judul Artikel</label>
                                <input type="text" class="form-control" id="judul" name="title" placeholder="Masukkan disini...." value="{{$article->title}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="img-article-wrapper full-width mb-3">
                                <img src="{{asset('uploaded_files/article-image/'.$article->image)}}" alt="Cover" class="full-width fit-cover" id="article-image">
                            </div>
                            <div id="editor1" class="wysiwyg mb-2 position-relative">
                                <textarea name="editor" cols="8" placeholder="Artikel ...">
                                    {{$article->content}}
                                </textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Sinopsis Artikel</label>
                                <textarea class="form-control" rows="4" placeholder="Sinopsis artikel"  name="synopsis">{{$article->synopsis}}</textarea>
                            </div>
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox"  @if ($article->public == '0') checked @endif  name="is_private">
