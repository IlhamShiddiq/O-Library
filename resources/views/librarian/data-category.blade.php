        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-4 p-0">
                ...
                <div class="gray-wrapper radius-admin">
                    ...
                    <a href="{{ url('/category') }}" class="btn btn-success full-width"><i class="fas fa-eye"></i> See All</a>
                </div>
                <div class="gray-wrapper radius-admin">
                  <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-8">
                <h1 class="title-pagination text-center mb-3">Data Kategori</h1>
                    ...
                    <div class="row">
                      <div class="col-8 pl-4 pr-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kategoriBuku') is-invalid @enderror" id="kategoriBuku" name="kategoriBuku" placeholder="Isikan disini...">
                            @error('kategoriBuku')
              ...
              <div class="modal-body py-3">
                <form action="{{url('/category/import')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <small for="file">Kolom dalam file harus terdiri atas : id, nama kategori</small>
                    @error('file')
                      <div id="validationServer03Feedback" class="invalid-feedback">
                        {{$message}}
                      </div>
