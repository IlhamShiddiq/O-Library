...
<html lang="en">
  ...
  <body>
            ...
            <div class="container-form-login">
                <div class="row justify-content-end">
                    ...
                    <div class="col-12 col-md-12 col-lg-4 text-center col-form">
                        <img src="img/vectors/admin.png" alt="Admin Icon" width="86">
                        <h1>WELCOME</h1>
                        <h4 class="mb-4">@yield('user')</h4>
                        <form method="POST" action="{{ url('/logged_in') }}">
                            @csrf
    ...
    <script src="js/close-message-btn.js"></script>
  </body>
</html>