    ...
    public function build()
    {
        ...
        return $this->from('perpustakaansmkn01@gmail.com', 'Perpustakaan SMKN 1 Cimahi')
                   ...
                   ->with([
                        ...
                        'pesan' => 'Ini adalah tahap terakhir sebelum anda dapat login ke web perpustakaan. Verifikasi akun anda untuk membuat username dan password anda sendiri. Masukkan kode berikut ke halaman konfirmasi akun.',
